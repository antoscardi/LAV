...
During this time, 
the UAVs successfully converged on the sources, achieving an average error of \(0.10 \, \text{m}\). 
...
due to the very high time reduction which did not consent the UAVs
to converge towards more precise positions. 
Instead, the time improvement was due to some UAVs 
