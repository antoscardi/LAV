...
\begin{itemize}
    \item Each UAV at each time step checks whether its current position 
...
\noindent\\
Note that the new goal is naturally set to be inside the boundaries of the search space.
