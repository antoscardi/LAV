classdef Plotter < handle
    ...
    methods
        ...
        function obj = Plotter(p_sources, bounds, n_drones, group_indices, n_groups, initial_positions)
            ...
            obj.scatter_sources = scatter(p_sources(:,1), p_sources(:,2), 200, 'red', '*'); % Mark sources in red
            hold on;
            
            % Initialize scatter plot for drones with their respective group colors
            obj.scatter_drones = scatter(initial_positions(:,1), initial_positions(:,2), 70, obj.drone_colors, 'filled');
        ...
        function plot_best(obj, g_best_local, group_indices)
            ...
            for i = 1:size(g_best_local, 1)
                ...
                obj.plot_handles(i) = scatter(g_best_local(i, 1), g_best_local(i, 2), 100, obj.colors(group_indices(i), :), '*');
            ...
            title('Final Drone Positions and Group-Based Best Estimates');
            hold off;
        end
    end
end
