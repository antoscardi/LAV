function particles = init_drones(n_drones, bounds, group_indices, max_velocity, velocity_randomness)
    ...
    %   - particles: Cell array of initialized Particle objects (one per drone).
        ...
        for i = 1:n_drones
            ...
            particles{i} = Particle(goal, velocity_randomness, max_velocity, bounds, group_indices(i), i, n_drones);  
        end
    end
